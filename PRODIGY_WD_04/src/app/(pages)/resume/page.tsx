...
const TIMELINES = [
  {
    ...
    timeline: [
      {
        title: "piet, Jaipur champus",
        date: "2022 - present",
        text: "I am currently studying in this college. I am studying Computer Engineering. I am 3st year student. ",
      },
      {
        title: "shiv jyoti senior secondary Boarding School",
        date: "20020 — 2022",
